...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/students/list","/students/showFormForAdd","/students/save").hasAnyAuthority("NORMAL_USER","ADMIN_USER")
		.antMatchers("/students/showFormForUpdate","/students/delete").hasAuthority("ADMIN_USER")
